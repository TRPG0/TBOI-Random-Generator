...
img_randomize.addEventListener("click", function(e) {
    ...
    if (currentlyRandomizing == false) {
        ...
        // set the images to be invisible until the randomizer finishes running
        if (numberPlayers == "1") {
        ...
        if (goals.length != 0) {
            ...
            // if Mother or The Beast, ignore Hush but allow Boss Rush
                ...
                if (finalTimed == "Boss Rush") {
                    finalGoal.innerHTML = "Defeat: Boss Rush and " + finalObj;
            ...
            // else, allow any goal and timed goal together
                ...
                finalGoal.innerHTML = "Defeat: " + finalTimed + " and " + finalObj;
                if (finalTimed == "Boss Rush") {
                    img_obj1.src = "assets/img/g8.png";
        ...
        if (challenges.length != 0) {
            ...
            for (i = 0; i < challenges2.length; i++) {
                labelArray.forEach(function(elem) {
                    if (elem.htmlFor == challenges2[i]) {
                        ...
                        challenges3.push(elem.innerHTML);
                    }
                });
            ...
            if (challenges3.length != 0) {
                finalChallenge.innerHTML = "Challenges: " + challenges3.join(", ");
            } else {
                finalChallenge.innerHTML = "Challenges: None";
            }
        ...
        // wait for the images to be loaded properly before making them visible and making the randomizer usable again
        ...
        async function showResults() {
            ...
            if (numberPlayers == "1") {
                ...
                while (true) {
                    ...
                    if (img_charSolo.complete && loadc1 == false && customTextSolo.innerHTML == "") {
                        loadc1 = true;
                        loadedImages++;
                    } else if (loadc1 == false && customTextSolo.innerHTML != "") {
                        loadc1 = true;
                        loadedImages++;
                    }
                    if (img_nameSolo.complete && loadn1 == false && customTextSolo.innerHTML == "") {
                        loadn1 = true;
                        loadedImages++;
                    } else if (loadn1 == false && customTextSolo.innerHTML != "") {
                        loadn1 = true;
                        loadedImages++;
                    }
                    if (img_obj1.complete && loado1 == false) {
                        loado1 = true;
                        loadedImages++;
                    }
                    if (img_obj2.complete && loado2 == false) {
                        loado2 = true;
                        loadedImages++;
                    }
                    if (loadedImages == 4) {
                        ...
                        challengeImgArray = document.querySelectorAll("#challengeContainer img");
                ...
                while (true) {
                    ...
                    if (img_charDuo1.complete && loadc1 == false && customTextDuo1.innerHTML == "") {
                        loadc1 = true;
                        loadedImages++;
                    } else if (loadc1 == false && customTextDuo1.innerHTML != "") {
                        loadc1 = true;
                        loadedImages++;
                    }
                    if (img_nameDuo1.complete && loadn1 == false && customTextDuo1.innerHTML == "") {
                        loadn1 = true;
                        loadedImages++;
                    } else if (loadn1 == false && customTextDuo1.innerHTML != "") {
                        loadn1 = true;
                        loadedImages++;
                    }
                    if (img_charDuo2.complete && loadc2 == false && customTextDuo2.innerHTML == "") {
                        loadc2 = true;
                        loadedImages++;
                    } else if (loadc2 == false && customTextDuo2.innerHTML != "") {
                        loadc2 = true;
                        loadedImages++;
                    }
                    if (img_nameDuo2.complete && loadn2 == false && customTextDuo2.innerHTML == "") {
                        loadn2 = true;
                        loadedImages++;
                    } else if (loadn2 == false && customTextDuo2.innerHTML != "") {
                        loadn2 = true;
                        loadedImages++;
                    }
                    if (img_obj1.complete && loado1 == false) {
                ...
                while (true) {
                    ...
                    if (img_charTrio1.complete && loadc1 == false && customTextTrio1.innerHTML == "") {
                        loadc1 = true;
                        loadedImages++;
                    } else if (loadc1 == false && customTextTrio1.innerHTML != "") {
                        loadc1 = true;
                        loadedImages++;
                    }
                    if (img_nameTrio1.complete && loadn1 == false && customTextTrio1.innerHTML == "") {
                        loadn1 = true;
                        loadedImages++;
                    } else if (loadn1 == false && customTextTrio1.innerHTML != "") {
                        loadn1 = true;
                        loadedImages++;
                    }
                    if (img_charTrio2.complete && loadc2 == false && customTextTrio2.innerHTML == "") {
                        loadc2 = true;
                        loadedImages++;
                    } else if (loadc2 == false && customTextTrio2.innerHTML != "") {
                        loadc2 = true;
                        loadedImages++;
                    }
                    if (img_nameTrio2.complete && loadn2 == false && customTextTrio2.innerHTML == "") {
                        loadn2 = true;
                        loadedImages++;
                    } else if (loadn2 == false && customTextTrio2.innerHTML != "") {
                        loadn2 = true;
                        loadedImages++;
                    }
                    if (img_charTrio3.complete && loadc3 == false && customTextTrio3.innerHTML == "") {
                        loadc3 = true;
                        loadedImages++;
                    } else if (loadc3 == false && customTextTrio3.innerHTML != "") {
                        loadc3 = true;
                        loadedImages++;
                    }
                    if (img_nameTrio3.complete && loadn3 == false && customTextTrio3.innerHTML == "") {
                        loadn3 = true;
                        loadedImages++;
                    } else if (loadn3 == false && customTextTrio3.innerHTML != "") {
                        loadn3 = true;
                        loadedImages++;
                    }
                    if (img_obj1.complete && loado1 == false) {
                ...
                while (true) {
                    ...
                    if (img_charQuad1.complete && loadc1 == false && customTextQuad1.innerHTML == "") {
                        loadc1 = true;
                        loadedImages++;
                    } else if (loadc1 == false && customTextQuad1.innerHTML != "") {
                        loadc1 = true;
                        loadedImages++;
                    }
                    if (img_charQuad2.complete && loadc2 == false && customTextQuad2.innerHTML == "") {
                        loadc2 = true;
                        loadedImages++;
                    } else if (loadc2 == false && customTextQuad2.innerHTML != "") {
                        loadc2 = true;
                        loadedImages++;
                    }
                    if (img_charQuad3.complete && loadc3 == false && customTextQuad3.innerHTML == "") {
                        loadc3 = true;
                        loadedImages++;
                    } else if (loadc3 == false && customTextQuad3.innerHTML != "") {
                        loadc3 = true;
                        loadedImages++;
                    }
                    if (img_charQuad4.complete && loadc4 == false && customTextQuad4.innerHTML == "") {
                        loadc4 = true;
                        loadedImages++;
                    } else if (loadc4 == false && customTextQuad4.innerHTML != "") {
                        loadc4 = true;
                        loadedImages++;
                    }
                    if (img_obj1.complete && loado1 == false) {
...
markAsCompleteDiv.addEventListener("click", function(e) {
    ...
    // prevent anything from happening if the randomizer hasn't actually been used yet
        ...
        // different alerts depending on 1 or 2 objectives
        if (markObj2Txt != undefined){
            alert("Marked as complete:\n" + markCharTxt + " defeated " + markObj1Txt + " and " + markObj2Txt + ".");
        } else {
            alert("Marked as complete:\n" + markCharTxt + " defeated " + markObj1Txt + ".");
        }
