...
// clicking on the challenge icons displays an alert with the name of the challenge
challengeContainer.addEventListener("click", function(e) {

    var clicked = "ch" + e.target.src.split("ch")[1].split(".png")[0];
    var clicked2 = document.getElementById(clicked);
    alert("Challenge: " + clicked2.labels[0].innerText);
...
// update the size of the shadow overlay graphic
function updateShadowSize() {
    spriteSizeX = parseFloat((img_page.getBoundingClientRect().width / img_page.naturalWidth).toPrecision(5));
    img_shadow.style.width = img_shadow.naturalWidth * spriteSizeX + "px";
}
